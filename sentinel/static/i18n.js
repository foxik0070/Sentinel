...
const TRANSLATIONS = {
  cs: {
    ...
    dash_temp_sparklines: 'Teploty hostů',
    dash_system: 'Systém',
    dash_health_trend: 'Zdraví systému (7 dní)',
    dash_flapping: 'Nejčastěji blikající issues (7 dní)',
    ...
    duration_col: 'Délka',
    showing_max_100: 'Zobrazeno max. 30 posledních relací na cluster.',
    root_active_badge: 'AKTIVNÍ',
    root_audit_export_csv: 'Export CSV',
    root_audit_active_only: 'Jen aktivní',
    user_online_now: 'Právě přihlášen',
    user_last_login: 'Poslední přihlášení',
    user_total_online: 'Celkem online',
    user_login_count: 'Počet přihlášení',
    user_first_seen: 'Poprvé viděn',
    user_since: 'od',
    user_never_logged_in: 'Zatím se nepřihlásil',
    graph_history: 'Historie',
    graph_prediction: 'Predikce (trend)',
    graph_current: 'Aktuálně',
    graph_change: 'Změna',
    graph_forecast: 'Předpověď',
    graph_samples: 'Vzorků',
    graph_ago: 'zpět',
    graph_pick_metric: '— vyberte metriku —',
  ...
  en: {
    ...
    dash_temp_sparklines: 'Host Temperatures',
    dash_system: 'System',
    dash_health_trend: 'System Health (7 days)',
    dash_flapping: 'Top Flapping Issues (7 days)',
    ...
    showing_max_100: 'Showing max. 30 most recent sessions per cluster.',
    root_active_badge: 'ACTIVE',
    root_audit_export_csv: 'Export CSV',
    root_audit_active_only: 'Active only',
    user_online_now: 'Currently signed in',
    user_last_login: 'Last login',
    user_total_online: 'Total online',
    user_login_count: 'Login count',
    user_first_seen: 'First seen',
    user_since: 'since',
    user_never_logged_in: 'Has never signed in',
    graph_history: 'History',
    graph_prediction: 'Prediction (trend)',
    graph_current: 'Current',
    graph_change: 'Change',
    graph_forecast: 'Forecast',
    graph_samples: 'Samples',
    graph_ago: 'ago',
    graph_pick_metric: '— select a metric —',
